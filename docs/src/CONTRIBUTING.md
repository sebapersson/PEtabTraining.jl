# Contributing to PEtabTraining.jl

First, thanks for taking the time to contribute to PEtabTraining.jl! Contributions of all
...
[GitHub](https://github.com/sebapersson/PEtabTraining.jl/issues) and include:
...
- Version information (Julia version, PEtabTraining.jl version, and OS)

## Suggesting enhancements

New ideas are welcome. Before opening a new issue, check the
[issue tracker](https://github.com/sebapersson/PEtabTraining.jl/issues) to see whether it
